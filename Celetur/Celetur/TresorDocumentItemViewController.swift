...
class TresorDocumentItemViewController: UITableViewController, NSFetchedResultsControllerDelegate {
  ...
  var tresorDocument: TresorDocument? = nil
  ...
  var fetchedResultsController: NSFetchedResultsController<TresorDocumentItem> {
      ...
      let aFetchedResultsController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: self.managedObjectContext!, sectionNameKeyPath: nil, cacheName: "TresorDocumentItem")
